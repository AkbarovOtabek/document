...
#         model = OrgEmployee
#         fields = [
#             "id", "full_name", "position_title", "work_phone", "email", "lotus",
#             "is_head", "order", "unit", "organization", "created_at",
#         ]
#         read_only_fields = [ "created_at"]
# class OrgEmployeeBriefSerializer(serializers.ModelSerializer):
#     # универсальные поля (что есть — то и отдадим)
...
#             "fio",
#             "phone",
#             "email",          # если есть код роли
#             "position_display",  # красивое имя роли
#             "is_head",           # начальник подразделения?
#         ]
