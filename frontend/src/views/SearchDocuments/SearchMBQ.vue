...
export default {
  ...
  methods:{
    async onSearch(){
      this.loading = true
      try{
        // TODO: заменить на реальный запрос к API MBQ
        await new Promise(r=>setTimeout(r,400))
        this.results = [
          { id:11, number:'MBQ-017', name:'Согласование договора', performer:'Петров', date:'2025-06-01', description:'Описание…' },
        ]
      }finally{
        this.loading = false
      }
  ...
  <div class="wrap">
    ...
    <div class="filters">
      <div class="row">
        ...
        <div class="col">
          <label>Номер</label>
          <input v-model.trim="form.number" type="text" />
        </div>
        <div class="col">
