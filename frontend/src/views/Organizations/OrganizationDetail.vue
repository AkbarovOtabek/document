...
<template>
  <div class="scene" :class="themeClass">
    ...
    <section v-if="org" class="grid">
      ...
      <!-- ПРАВО: Куратор -->
      <article class="card responsibles">
        <div class="card-inner">
          <h3 class="block-title">Куратор</h3>
            ...
            <div class="resp-item one">
              ...
              <div class="resp-info">
                ...
                <div class="resp-contacts">
                  ...
                  <span class="muted" v-if="curator.email">✉ {{ curator.email }}</span>
                </div>
              </div>
            </div>
          </template>

          <p v-else class="muted">Куратор не назначен.</p>
        </div>
      </article>
